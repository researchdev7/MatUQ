...
if __name__ == '__main__':
    ...
    task_uncert_mc_A = {}
    for ood in oods:
        train_sets_file = "folds/" + args.task + "_folds/train/SOAP_" + args.task + "_" + ood + "_target_clusters" + str(args.n_cluster)+"_train.json"
        valid_sets_file = "folds/" + args.task + "_folds/val/SOAP_" + args.task + "_" + ood + "_target_clusters" + str(args.n_cluster)+"_val.json"
        test_sets_file = "folds/" + args.task + "_folds/test/SOAP_" + args.task + "_" + ood + "_target_clusters" + str(args.n_cluster)+"_test.json"
        ...
        for i in range(args.n_cluster):
            ...
            if not os.path.exists(
                    'results/' + args.model + '/' + args.task + '/' + args.feature + '_' + ood + str(args.n_cluster) + '/fold_' + str(i)):
                os.makedirs('results/' + args.model + '/' + args.task + '/' + args.feature + '_' + ood + str(args.n_cluster) + '/fold_' + str(i))
            save_dir = 'results/' + args.model + '/' + args.task + '/' + args.feature + '_' + ood + str(args.n_cluster) + '/fold_' + str(i)
        ...
        with open('results/' + args.model + '/' + args.task + '/' + args.feature + '_' + ood + str(args.n_cluster) + '/' + 'test_metrics.csv', 'w') as f:
            writer = csv.writer(f)
