...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", default="perovskites", type=str, help="dielectric, elasticity, perovskites")
    ...
    for ood in oods:
        ...
        for i in range(3, 4):
            ...
            if config["Models"]["model"] == "DimeNetPP_TF":
                ...
                save_dir = 'results/' + args.model + '/' + args.task + '/soap_' + ood + str(args.n_cluster) + '/fold_' + str(i)
        ...
        with open('results/' + args.model + '/' + args.task + '/soap_' + ood + str(args.n_cluster) + '/' + 'test_metrics.csv', 'w') as f:
            writer = csv.writer(f)
